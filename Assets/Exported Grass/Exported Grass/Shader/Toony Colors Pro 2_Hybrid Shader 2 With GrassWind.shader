Shader "Toony Colors Pro 2/Hybrid Shader 2 With GrassWind" {
	Properties {
		...
		[TCP2HeaderToggle(Grass wind effect)] _UseWind ("Wind Effect", Float) = 1
		_BackedWindTime ("Backed Wind Time", Float) = -1
		...
		[Toggle()] _UsePositionSeed ("Use Position as Seed", Float) = 1
		_CustomSeed ("Use Position as Seed", Float) = -1
